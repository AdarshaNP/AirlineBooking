...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.inMemoryAuthentication().withUser("Aadhi").password("12345").roles("ADMIN");
        
        //.and()
        // .withUser("Kumar").password("78945").roles("ADMIN");
...
//                .authoritiesByUsernameQuery("Select name,role from users where name=?");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/api/v1.0/flight/airline/inventory/getflights").authenticated()
